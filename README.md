...
2. What is an event?
Is any action that is done by the user 

3. What is an event listener?
waiting for the event to happen before excuting its code

4. Why would we convert a NodeList into an Array?
because node list only a small range of option to use the data so changing it to an array allows us to do more with the data

5. What is a component?
is a melting pot of html, js, and css all in one spot
